...
<a style="margin-right: 25px;" type="button" class="btn btn-warning btn-md" href="../../../siswa/tkj/tampil-tkj.php?nik=<?php echo $d['nik']; ?>">Cetak PDF</a>


<table class="table table-bordered">
  <form class="" action="tkj-proses.php" method="post">
    <tr>
