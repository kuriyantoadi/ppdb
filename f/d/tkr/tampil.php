...
<a style="margin-right: 25px;" type="button" class="btn btn-warning btn-md" href="../../../siswa/tkr/tampil-tkr.php?nik=<?php echo $d['nik']; ?>">Cetak PDF</a>


<table class="table table-bordered">
  <form class="" action="tkr-proses.php" method="post">
    <tr>
    ...
    <tr>
      ...
      <td>
        <embed src="../../../siswa/tkr/file/<?php echo $d['pdf_skhun']; ?>" type="application/pdf" width="100%" height="500px">
      </td>
    </tr>
    <tr>
