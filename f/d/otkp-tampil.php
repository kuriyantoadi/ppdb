...
<div class="container">
  ...
  <div class="container-fluid">
	<div class="row">
      ...
      <center><h3>Kompetensi Otomatisasi dan Tata Kelola Perkantoran</h3></center>
		</div>
		<div class="col-md-3">
		</div>
  </div>
  ...
  <table class="table table-bordered">
    ...
    <table class="table table-bordered">
      ...
      <tr>
        <td>
          <center><a type="button" class="btn btn-primary btn-md" href="otkp-terima.php?nomor_pendaftaran=<?php echo $d['nomor_pendaftaran']; ?>" onclick="return confirm('Anda yakin <?php echo $d['nama_siswa']; ?>, terima ?')" > Diterima</a>
        </td>
        <td>
          <center><a type="button" class="btn btn-warning btn-md" href="otkp-tolak.php?nomor_pendaftaran=<?php echo $d['nomor_pendaftaran']; ?>" onclick="return confirm('Anda yakin <?php echo $d['nama_siswa']; ?>, tidak terima ?')" >Tidak diterima</a>
        </td>
