...
<div class="container">
  ...
  <table class="table table-bordered">
    ...
    <table class="table table-bordered">
      ...
      <tr>
        <td>
          <center><a type="button" class="btn btn-primary btn-md" href="otkp-terima.php?no_p=<?php echo $d['no_p']; ?>" onclick="return confirm('Anda yakin <?php echo $d['nama_siswa']; ?>, terima ?')" > Diterima</a>
        </td>
        <td>
          <center><a type="button" class="btn btn-warning btn-md" href="otkp-tolak.php?no_p=<?php echo $d['no_p']; ?>" onclick="return confirm('Anda yakin <?php echo $d['nama_siswa']; ?>, tidak terima ?')" >Tidak diterima</a>
        </td>
