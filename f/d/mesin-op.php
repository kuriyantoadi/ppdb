...
<div class="container">
  ...
  <tbody>
    <?php
      include '../../koneksi.php';
      $no = 1;
      $data = mysqli_query($koneksi,"select * from f_siswa where kompetensi_keahlian='Teknik Pemesinan'");
    ...
    <tr>
      ...
      <td><center>
        <a type="button" class="btn btn-info btn-sm" href="mesin-tampil.php?nomor_pendaftaran=<?php echo $d['nomor_pendaftaran']; ?>" >Lihat</a>
      </td>
    </tr>
