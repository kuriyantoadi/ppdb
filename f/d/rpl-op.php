...
<div class="container">
  ...
  <tbody>
    <?php
      include '../../koneksi.php';
      $no = 1;
      $data = mysqli_query($koneksi,"select 'id' 'no_p' 'nisn' 'nama_siswa' 'kompetensi_keahlian' 'asal_sekolah' 'kondisi'
      from f_siswa where kompetensi_keahlian='Rekayasa Perangkat Lunak'");
