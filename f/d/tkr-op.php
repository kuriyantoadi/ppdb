...
<div class="container">
  ...
  <tbody>
    <?php
      include '../../koneksi.php';
      $no = 1;
      $data = mysqli_query($koneksi,"select * from f_siswa where kompetensi_keahlian='Teknik Kendaraan Ringan'");
    ...
    <tr>
      ...
      <td><center>
        <a type="button" class="btn btn-info btn-sm" href="tkr-tampil.php?nomor_pendaftaran=<?php echo $d['nomor_pendaftaran']; ?>" >Lihat</a>
      </td>
    </tr>
