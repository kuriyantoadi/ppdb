...
<div class="container">
  ...
  <tbody>
    <?php
      include '../../koneksi.php';
      $no = 1;
      $data = mysqli_query($koneksi,"select * from f_siswa where kompetensi_keahlian='Otomatisasi dan Tata Kelola Perkantoran'");
    ...
    <tr>
      ...
      <td><center>
        <a type="button" class="btn btn-info btn-sm" href="otkp-tampil.php?id=<?php echo $d['id']; ?>" >Lihat</a>
      </td>
    </tr>
