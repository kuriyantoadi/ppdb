  ...
  <div class="container">
    ...
    <div class="form-group">
      <div class="col-sm-7">
        ...
        <a href="tkr-lap.php" type="button" class="btn btn-success" onclick="return confirm('Download Data PPDB Kompetensi Keahlian Teknik Kendaraan Ringan ?')">Download TKR</a>
    ...
    <table class="table table-bordered table-hover" id="domainsTable">
      ...
      while ($d = mysqli_fetch_array($data)) {
        ...
        <tr>
          ...
          <td>
            <center>
              <a type="button" class="btn btn-info btn-sm" href="tkr-lihat.php?id=<?php echo $d['id']; ?>">Lihat</a>
          </td>
          <td>
            <center>
          ...
          <td>
            <center>
              <a type="button" class="btn btn-danger btn-sm" href="tkr-hapus.php?id=<?php echo $d['id']; ?>" onclick="return confirm('Anda yakin Hapus data siswa <?php echo $d['nama_siswa']; ?> ?')">Hapus</a>
          </td>
        </tr>
