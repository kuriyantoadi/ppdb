...
<table>
  <tr>
    ...
    <td>
      <a style="margin-right: 10px; margin-bottom: 25px;" class="btn btn-primary btn-md" href="../../../siswa/akl/tampil-akl.php?nik=<?php echo $d['nik']; ?>">Cetak PDF</a>
    </td>
  </tr>
</table>
...
<table class="table table-bordered">
  ...
  <tr>
    ...
    <td>
      ...
      <a type="button" class="btn btn-info btn-sm" href="../../../siswa/akl/file/<?php echo $d['pdf_surat_dokter']; ?>">Surat Dokter PDF</a>
    </td>
  </tr>
  <tr>
    ...
    <td>
      ...
      <a type="button" class="btn btn-info btn-sm" href="../../../siswa/akl/file/<?php echo $d['pdf_kk']; ?>">Kartu Keluarga PDF</a>
    </td>
  </tr>
  <tr>
    ...
    <td>
      ...
      <a type="button" class="btn btn-info btn-sm" href="../../../siswa/akl/file/<?php echo $d['pdf_akta']; ?>">Akta Kelahiran PDF</a>
    </td>
  </tr>
  <tr>
    <td>Photo</td>
    <td>
      ...
      <a type="button" class="btn btn-info btn-sm" href="../../../siswa/akl/file/<?php echo $d['pdf_photo']; ?>">Photo PDF</a>
    </td>
  </tr>
  <tr>
    <td>SwaPhoto</td>
    <td>
      ...
      <a type="button" class="btn btn-info btn-sm" href="../../../siswa/akl/file/<?php echo $d['pdf_swa_kk']; ?>">SwaPhoto PDF</a>
    </td>
  </tr>
  <tr>
    <td>Piagam 1</td>
    <td>
      ...
      <a type="button" class="btn btn-info btn-sm" href="../../../siswa/akl/file/<?php echo $d['pdf_piagam1']; ?>">Piagam 1 PDF</a>
    </td>
  </tr>
  <tr>
    <td>Piagam 2</td>
    <td>
      ...
      <a type="button" class="btn btn-info btn-sm" href="../../../siswa/akl/file/<?php echo $d['pdf_piagam2']; ?>">Piagam 2 PDF</a>
    </td>
  </tr>
  <tr>
    <td>Piagam 3</td>
    <td>
      ...
      <a type="button" class="btn btn-info btn-sm" href="../../../siswa/akl/file/<?php echo $d['pdf_piagam3']; ?>">Piagam 3 PDF</a>
    </td>
  </tr>
